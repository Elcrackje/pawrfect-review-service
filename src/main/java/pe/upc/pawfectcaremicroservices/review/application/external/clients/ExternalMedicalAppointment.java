...
public class ExternalMedicalAppointment {
    ...
    public boolean existsMedicalAppointmentById(Long medicalAppointmentId) {
        try {
            restTemplate.getForObject("https://pawfect-gateway-service.azurewebsites.net/appointment-service/api/v1/appointments/{medicalAppointmentId}", Object.class, medicalAppointmentId);
            return true;
